...
public class Examples {
	...
	TennisScore match1 = new TennisScore ( TennisSet1);       // valid
	TennisScore match2 = new TennisScore ( TennisSet2, TennisSet3, TennisSet4);
	TennisScore match3 = new TennisScore ( TennisSet1, TennisSet2, TennisSet3, TennisSet4);
	TennisScore match4 = new TennisScore ( TennisSet1,TennisSet2, TennisSet3, TennisSet4, TennisSet7);
	TennisScore match5 = new TennisScore ( TennisSet1, TennisSet6); 
	TennisScore match6 = new TennisScore ( TennisSet9);     // invalids
	TennisScore match7 = new TennisScore ( TennisSet10, TennisSet2);
	TennisScore match8 = new TennisScore ( TennisSet11);
	TennisScore match9 = new TennisScore ( TennisSet12, TennisSet11, TennisSet9, TennisSet8, TennisSet10);
	TennisScore match10 = new TennisScore (TennisSet11, TennisSet12, TennisSet2);
	TennisScore match11 = new TennisScore (TennisSet1, TennisSet2, TennisSet8);
